...
const t = useTranslations()
    return (
       <>
        <div className='container mx-auto flex items-center  mt-10   h-screen '>
            <div className="right">   
                <p className='uppercase text-error mt-12 text-[26px] leading-24'>{t("destinations")}</p>
                ...
                <div className='flex items-center gap-4'>
                    <button className='shadow dark:text-gray-200 px-7 py-4 bg-amber-500 text-white mt-3 rounded-xl'>{t("Find out more")}</button>
            ...
            <div className="left flex items-end justify-end mt-5">
                <Image className='' src={image} alt='traveller' width={600} height={600} />
            </div>
        </div></>
    )
}
